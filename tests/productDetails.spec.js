...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    expect(productDetails('Alcool gel', 'Máscara')[0].details.productId.substr(-3)).toBe('123');
    expect(productDetails('Alcool gel', 'Máscara')[1].details.productId.substr(-3)).toBe('123');
