...
/*
 ...
 describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
   it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
     ...
     // ```
     expect(Object.keys(createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} }).fetchMenu())).toEqual(['food', 'drink']);
     ...
     // --------------------------------------------------------------------------------------
     const test5 = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
     test5.order('coxinha')
    ...
    // ```
    const test6 = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    test6.order('coxinha');
    test6.order('agua');
    test6.order('sopa');
    test6.order('sashimi');
    ...
    // --------------------------------------------------------------------------------------
    const test7 = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    test7.order('coxinha');
    test7.order('agua');
    test7.order('coxinha');
    ...
    const test8 = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    test8.order('coxinha');
    test8.order('agua')
    test8.order('coxinha');
    expect(test8.pay()).toEqual(12.87);
